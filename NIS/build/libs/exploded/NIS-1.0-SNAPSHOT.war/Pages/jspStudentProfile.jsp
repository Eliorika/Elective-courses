...
<body bgcolor=#FFEBCD>
	<div id="welcome">
		...
		<div id="content">
			...
			<form>
				<div class="profile">
					<img src="image/office.png" weight="250" height="250">
					<P>
						Your name: <input id="txtName" type="text" NAME="txtName">
					</P>
					<P>
						Login: <input id="txtLogin" type="text" NAME="txtLogin" value=${login}>
					</P>
					<P>
